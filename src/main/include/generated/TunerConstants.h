...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 5.96_mps;

private:
    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    static constexpr units::scalar_t kCoupleRatio = 3.125;

    static constexpr units::scalar_t kDriveGearRatio = 5.357142857142857;
...
private:
    ...
    // Front Left
    static constexpr int kFrontLeftDriveMotorId = 14;
    static constexpr int kFrontLeftSteerMotorId = 15;
    static constexpr int kFrontLeftEncoderId = 3;
    static constexpr units::turn_t kFrontLeftEncoderOffset = 0.4970703125_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = 17.15_in;
    static constexpr units::inch_t kFrontLeftYPos = 19.7_in;

    // Front Right
    static constexpr int kFrontRightDriveMotorId = 12;
    static constexpr int kFrontRightSteerMotorId = 13;
    static constexpr int kFrontRightEncoderId = 2;
    static constexpr units::turn_t kFrontRightEncoderOffset = 0.1318359375_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = 17.15_in;
    static constexpr units::inch_t kFrontRightYPos = -19.7_in;

    // Back Left
    static constexpr int kBackLeftDriveMotorId = 16;
    static constexpr int kBackLeftSteerMotorId = 17;
    static constexpr int kBackLeftEncoderId = 4;
    static constexpr units::turn_t kBackLeftEncoderOffset = 0.333740234375_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -17.15_in;
    static constexpr units::inch_t kBackLeftYPos = 19.7_in;
    ...
    static constexpr units::turn_t kBackRightEncoderOffset = 0.18798828125_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -17.15_in;
    static constexpr units::inch_t kBackRightYPos = -19.7_in;
